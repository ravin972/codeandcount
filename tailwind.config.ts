...
export default {
  ...
  theme: {
      ...
      backgroundImage: {
        'gradient-main-hero': "linear-gradient(140deg, hsl(var(--primary) / 0.20) 0%, hsl(var(--background)) 50%)",
        'gradient-main-hero-light': "linear-gradient(140deg, hsl(var(--primary) / 0.10) 0%, hsl(var(--background)) 50%)",
