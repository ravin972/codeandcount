...
import { ArrowUpRight, Phone, Mail, MapPin, Star, ExternalLinkIcon } from 'lucide-react';
...
const footerSections = {
  ...
  learn: {
    ...
    links: [
      ...
      { text: "Blog", href: "/blog" },
      { text: "FAQs", href: "/faq" }, // Placeholder
    ]
  },
  explore: {
    title: "Explore",
  ...
  getInTouch: {
    ...
    otherLink: { text: "///your.unique.link", href: "#" } // Placeholder for what3words-like link
  }
};

const foundingYear = 2010; // As per image "Crafting since 2010"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16 md:mb-24">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center">
                <ExternalLinkIcon className="h-5 w-5 mr-3 text-primary flex-shrink-0" /> {/* Using generic link icon */}
